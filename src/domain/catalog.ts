...
export const products = [
  ...
  record({
    availability: 0,
    description:
      "Collector booster per chi cerca trattamenti speciali e personaggi di Final Fantasy in Magic.",
    game: "Magic: The Gathering",
    gameSlug: "magic",
    id: "mtg-final-fantasy-cb",
    image: image("FINAL FANTASY\nCOLLECTOR BOX", "181b24"),
    language: "ENG",
    ...
    set: "Final Fantasy",
    sku: "MTG-FF-ENG-CB",
    slug: "final-fantasy-collector-booster-box",
    status: "sold-out",
  ...
  record({
    availability: 7,
    description:
      "Draghi, clan e nuovi mazzi da draft in un play booster box da trentasei buste.",
    game: "Magic: The Gathering",
    gameSlug: "magic",
    id: "mtg-tarkir-bb",
    image: image("TARKIR\nDRAGONSTORM", "181b24"),
    ...
    sku: "MTG-TDM-ENG-PB",
    slug: "tarkir-dragonstorm-play-booster-box",
    status: "available",
