...
export const products = [
  record({
    ...
    gameSlug: "one-piece",
    id: "op09-bb-eng",
    image: "https://files.catbox.moe/t4n27q.png",
    language: "ENG",
  ...
  record({
    ...
    gameSlug: "one-piece",
    id: "op10-bb-eng",
    image: "https://files.catbox.moe/getbkd.png",
    language: "ENG",
  ...
  record({
    ...
    gameSlug: "one-piece",
    id: "op08-bb-eng",
    image: "https://files.catbox.moe/ut0iuf.png",
    language: "ENG",
  ...
  record({
    ...
    gameSlug: "pokemon",
    id: "pkm-mega-etb-ita",
    image: "https://files.catbox.moe/6auabf.png",
    language: "ITA",
  ...
  record({
    ...
    image: "https://files.catbox.moe/l873t5.png",
    language: "ENG",
  ...
  record({
    ...
    image: "https://files.catbox.moe/yvhvjr.png",
    language: "ENG",
  ...
  record({
    ...
    gameSlug: "magic",
    id: "mtg-tarkir-cb",
    image: "https://files.catbox.moe/99rpju.png",
    language: "ENG",
  ...
  record({
    ...
    image: "https://files.catbox.moe/18idy7.png",
    language: "ENG",
